...
public class MenuPrincipal {
   ...
   private void ingresarAlSistema() throws ExcepcionMifo {
    ...
    private void crearCuenta() {
        ...
        String resultadoCreacion = empresa.crearUsuarioConCodigo(nombre, contrasena, correo);
        System.out.println(resultadoCreacion);
        int codigo = empresa.crearCodigoUsuario() - 1;
        usuario[indiceUsuarios++] = new Usuario(nombre, contrasena, correo, codigo);
